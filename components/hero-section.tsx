...
import { Shield, Lock, Star, StarHalf, Search, UserIcon } from "lucide-react"
import { startScan as trackStartScan } from "@/lib/analytics" // Renamed to avoid conflict
import { useLanguage } from "@/contexts/language-context"
import PhotoUpload from "./photo-upload"

interface HeroSectionProps {
  onStartScan: (name?: string, age?: string) => void
...
export default function HeroSection({ onStartScan, onPhotoUpload }: HeroSectionProps) {
  ...
  const handleStartScan = () => {
    ...
    trackStartScan()
    onStartScan(nameInput || undefined, ageInput || undefined)
  }
          ...
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <div className="flex flex-wrap items-center mt-4 gap-4">
              <div className="flex items-center">
                ...
                <span className="text-sm">{t("hero.secure.label")}</span>
              </div>
              <div className="flex items-center">
                <Shield className="text-gray-200 mr-2" size={14} />
                <span className="text-sm">{t("hero.encrypted.label")}</span>
              </div>
              <div className="flex items-center">
                <div className="flex items-center">
